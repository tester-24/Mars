...
describe.only('template spec', () => {
  ...
  it('passes', () => {
    ...
    //cy.xpath("//input[@id='k-9dd67446-b4cb-4595-9113-494766d010ef']").click();
    ...
    cy.wait(5000);
//cy.visit('https://mars.jainam.in/home');
  //  cy.xpath("/html/body/app-layout/app-dashboard/section/div/div/div/div/a[2]").invoke("removeAttr", "target") // Remove target="_blank" to avoid opening a new tab
  //  .click({timeout:3000});  
  //  cy.wait(5000);
...
//     cy.wait(8000);
//     //cy.xpath("//a[@id='ReportDropdown']").click();
//     cy.xpath("//a[normalize-space()='Trade Response Report']").click({force:true});
//     cy.wait(5000);
...
cy.xpath("(//a[@title='Performance'])[2]").click({force:true});
cy.wait(8000);
